<div class="wrap">
    ...
    <p style="font-size:15px;"><?php e_('这个项目的 Github 地址是 ', 'hui');?><a href="https://github.com/yrccondor/wp-hookui" target="_blank">github.com/yrccondor/wp-hookui</a><br><?php e_('欢迎提出 issue 或 PR 。', 'hui');?></p>
    <br>
